...
#define DEBUG_RUN(b1,b2) 	CPUExecute(b1) 											// Run a frame or to breakpoint, returns -1 if breakpoint
...
void DBGXWriteTTYDisplay(int x,int y,int ch);										// Write to teletype visual device.

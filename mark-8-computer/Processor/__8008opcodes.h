...
case 0x41: // in 00
    MA = 0x00;READPORT();A = MB;CYCLES(8);break;
case 0x42: // cnc @2
    FETCH16();if (Carry == 0) {PUSH();PCTR=temp16;};CYCLES(10);break;
case 0x43: // in 01
    MA = 0x01;READPORT();A = MB;CYCLES(8);break;
case 0x44: // jmp @2
    FETCH16();PCTR = temp16;CYCLES(11);break;
case 0x45: // in 02
    MA = 0x02;READPORT();A = MB;CYCLES(8);break;
case 0x46: // call @2
    FETCH16();PUSH();PCTR = temp16;CYCLES(11);break;
case 0x47: // in 03
    MA = 0x03;READPORT();A = MB;CYCLES(8);break;
case 0x48: // jnz @2
    FETCH16();if (PSZValue != 0) PCTR = temp16;CYCLES(10);break;
case 0x49: // in 04
    MA = 0x04;READPORT();A = MB;CYCLES(8);break;
case 0x4a: // cnz @2
    FETCH16();if (PSZValue != 0) {PUSH();PCTR=temp16;};CYCLES(10);break;
case 0x4b: // in 05
    MA = 0x05;READPORT();A = MB;CYCLES(8);break;
case 0x4c: // jmp @2
    FETCH16();PCTR = temp16;CYCLES(11);break;
case 0x4d: // in 06
    MA = 0x06;READPORT();A = MB;CYCLES(8);break;
case 0x4e: // call @2
    FETCH16();PUSH();PCTR = temp16;CYCLES(11);break;
case 0x4f: // in 07
    MA = 0x07;READPORT();A = MB;CYCLES(8);break;
case 0x50: // jp @2
    FETCH16();if ((PSZValue & 0x80) == 0) PCTR = temp16;CYCLES(10);break;
case 0x51: // out 08
    MA = 0x08;MB = A;WRITEPORT();CYCLES(6);break;
case 0x52: // cp @2
    FETCH16();if ((PSZValue & 0x80) == 0) {PUSH();PCTR=temp16;};CYCLES(10);break;
case 0x53: // out 09
    MA = 0x09;MB = A;WRITEPORT();CYCLES(6);break;
case 0x54: // jmp @2
    FETCH16();PCTR = temp16;CYCLES(11);break;
case 0x55: // out 0a
    MA = 0x0a;MB = A;WRITEPORT();CYCLES(6);break;
case 0x56: // call @2
    FETCH16();PUSH();PCTR = temp16;CYCLES(11);break;
case 0x57: // out 0b
    MA = 0x0b;MB = A;WRITEPORT();CYCLES(6);break;
case 0x58: // jpo @2
    FETCH16();if (_Parity(PSZValue) != 0) PCTR = temp16;CYCLES(10);break;
case 0x59: // out 0c
    MA = 0x0c;MB = A;WRITEPORT();CYCLES(6);break;
case 0x5a: // cpo @2
    FETCH16();if (_Parity(PSZValue) != 0) {PUSH();PCTR=temp16;};CYCLES(10);break;
case 0x5b: // out 0d
    MA = 0x0d;MB = A;WRITEPORT();CYCLES(6);break;
case 0x5c: // jmp @2
    FETCH16();PCTR = temp16;CYCLES(11);break;
case 0x5d: // out 0e
    MA = 0x0e;MB = A;WRITEPORT();CYCLES(6);break;
case 0x5e: // call @2
    FETCH16();PUSH();PCTR = temp16;CYCLES(11);break;
case 0x5f: // out 0f
    MA = 0x0f;MB = A;WRITEPORT();CYCLES(6);break;
case 0x60: // jc @2
    FETCH16();if (Carry != 0) PCTR = temp16;CYCLES(10);break;
case 0x61: // out 10
    MA = 0x10;MB = A;WRITEPORT();CYCLES(6);break;
case 0x62: // cc @2
    FETCH16();if (Carry != 0) {PUSH();PCTR=temp16;};CYCLES(10);break;
case 0x63: // out 11
    MA = 0x11;MB = A;WRITEPORT();CYCLES(6);break;
case 0x64: // jmp @2
    FETCH16();PCTR = temp16;CYCLES(11);break;
case 0x65: // out 12
    MA = 0x12;MB = A;WRITEPORT();CYCLES(6);break;
case 0x66: // call @2
    FETCH16();PUSH();PCTR = temp16;CYCLES(11);break;
case 0x67: // out 13
    MA = 0x13;MB = A;WRITEPORT();CYCLES(6);break;
case 0x68: // jz @2
    FETCH16();if (PSZValue == 0) PCTR = temp16;CYCLES(10);break;
case 0x69: // out 14
    MA = 0x14;MB = A;WRITEPORT();CYCLES(6);break;
case 0x6a: // cz @2
    FETCH16();if (PSZValue == 0) {PUSH();PCTR=temp16;};CYCLES(10);break;
case 0x6b: // out 15
    MA = 0x15;MB = A;WRITEPORT();CYCLES(6);break;
case 0x6c: // jmp @2
    FETCH16();PCTR = temp16;CYCLES(11);break;
case 0x6d: // out 16
    MA = 0x16;MB = A;WRITEPORT();CYCLES(6);break;
case 0x6e: // call @2
    FETCH16();PUSH();PCTR = temp16;CYCLES(11);break;
case 0x6f: // out 17
    MA = 0x17;MB = A;WRITEPORT();CYCLES(6);break;
case 0x70: // jm @2
    FETCH16();if ((PSZValue & 0x80) != 0) PCTR = temp16;CYCLES(10);break;
case 0x71: // out 18
    MA = 0x18;MB = A;WRITEPORT();CYCLES(6);break;
case 0x72: // cm @2
    FETCH16();if ((PSZValue & 0x80) != 0) {PUSH();PCTR=temp16;};CYCLES(10);break;
case 0x73: // out 19
    MA = 0x19;MB = A;WRITEPORT();CYCLES(6);break;
case 0x74: // jmp @2
    FETCH16();PCTR = temp16;CYCLES(11);break;
case 0x75: // out 1a
    MA = 0x1a;MB = A;WRITEPORT();CYCLES(6);break;
case 0x76: // call @2
    FETCH16();PUSH();PCTR = temp16;CYCLES(11);break;
case 0x77: // out 1b
    MA = 0x1b;MB = A;WRITEPORT();CYCLES(6);break;
case 0x78: // jpe @2
    FETCH16();if (_Parity(PSZValue) == 0) PCTR = temp16;CYCLES(10);break;
case 0x79: // out 1c
    MA = 0x1c;MB = A;WRITEPORT();CYCLES(6);break;
case 0x7a: // cpe @2
    FETCH16();if (_Parity(PSZValue) == 0) {PUSH();PCTR=temp16;};CYCLES(10);break;
case 0x7b: // out 1d
    MA = 0x1d;MB = A;WRITEPORT();CYCLES(6);break;
case 0x7c: // jmp @2
    FETCH16();PCTR = temp16;CYCLES(11);break;
case 0x7d: // out 1e
    MA = 0x1e;MB = A;WRITEPORT();CYCLES(6);break;
case 0x7e: // call @2
    FETCH16();PUSH();PCTR = temp16;CYCLES(11);break;
case 0x7f: // out 1f
    MA = 0x1f;MB = A;WRITEPORT();CYCLES(6);break;
case 0x80: // add a

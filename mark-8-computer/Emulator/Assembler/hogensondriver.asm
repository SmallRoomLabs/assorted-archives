...
Loop:
    ...
    hlt
Message:
    db      "LINE 1",13,"LINE 2",13,"ABCDEFGHIJKLMNOPQRSTUVWXYZ",13,0
...
;   which are immediate instructions at XPositionLoader and YPositionLoader
;
...
XPositionLoader:
    ...
    mvi     l,(XPositionLoader+1) & 255                         ; set HL to point to X position value 
    mvi     h,(XPositionLoader+1) / 256                         ; (H was changed by the drawing code)
...
PCNewLineCode:
    ...
    out     DisplayPort
    mvi     l,(YPositionLoader+1) & 255                         ; point HL to the Y Position Loader.
...
PCNewLineClear:
    out     DisplayPort                                         ; doing it in twos is quicker and also use byte counter
    out     DisplayPort
    dcr     e
    jnz     PCNewLineClear  
    mvi     l,(XPositionLoader+1) & 255                         ; zero the X position
    mov     m,e

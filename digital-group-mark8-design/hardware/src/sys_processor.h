...
#define RAMSIZE 	(6144)															// RAM we have.
...
BYTE8 HWIReadVideoMemory(BYTE8 offset);												// Read video memory
BYTE8 HWIReadTapeBit(void);															// Read a tape bit
void HWIWriteTapeBit(BYTE8 bit); 													// Write a tape bit

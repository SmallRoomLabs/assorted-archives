...
#define WIN_TITLE 		"Apple I Emulator"											// Initial Window stuff
...
#define DEBUG_ARGUMENTS(ac,av) if (ac == 2) IOSetStreamFile(argv[1]);													// Handle CLI arguments
...
#define DEBUG_KEYMAP(k,r)	DRVGFXHandler(k,r)

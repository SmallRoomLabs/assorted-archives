...
case 0xc1: /* $c1 cmp (@1,x) */
	CYCLES(7);temp8 = FETCH()+x;eac = READWORD01(temp8);carryFlag = 1;sValue = zValue = sub8Bit(a,READ(eac),0);break;
case 0xc4: /* $c4 cpy @1 */
...
case 0xd1: /* $d1 cmp (@1),y */
	CYCLES(6);temp8 = FETCH();eac = READWORD01(temp8)+y;carryFlag = 1;sValue = zValue = sub8Bit(a,READ(eac),0);break;
...
case 0xd9: /* $d9 cmp @2,y */
	CYCLES(4);FETCHWORD();eac = temp16+y;carryFlag = 1;sValue = zValue = sub8Bit(a,READ(eac),0);break;
case 0xdd: /* $dd cmp @2,x */
	CYCLES(4);FETCHWORD();eac = temp16+x;carryFlag = 1;sValue = zValue = sub8Bit(a,READ(eac),0);break;

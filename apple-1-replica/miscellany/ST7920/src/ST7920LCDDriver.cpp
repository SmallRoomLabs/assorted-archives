...
void ST7920LCDDriver::drawText(uint8_t x,uint8_t y,uint8_t *char4) {
    ...
    p1 = pgm_read_word_far(__fontData+(char4[0]-' '));
    p2 = pgm_read_word_far(__fontData+(char4[1]-' '));
    p3 = pgm_read_word_far(__fontData+(char4[2]-' '));
    p4 = pgm_read_word_far(__fontData+(char4[3]-' '));

...
static char scopeText[33] = "01234567890123456789012345678901";
...
// *******************************************************************************************************************************
//										Set the scopewriter text
// *******************************************************************************************************************************

void DBGXSetScopewriter(char *text) {
	strcpy(scopeText,text);
}
...
void DBGXRender(int *address,int showDisplay) {
	...
	GFXString(GRID(0,17),scopeText,GRIDSIZE,0xFFF,0x044);

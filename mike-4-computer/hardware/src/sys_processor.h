...
#ifdef ARDUINO
#define RAMSIZE	(4096)																// On the Arduino Mega, we have 6k of RAM (?)
#else
#define RAMSIZE (16384)																// Otherwise it is all RAM (mapped anyway)
#endif
...
void HWIWriteScopewriter(BYTE8 reg,BYTE8 data);										// Write to a Scopewriter register.
void HWIEndFrame(void);																// End of frame function

#define SCOPEWRITER_LOAD  	0														// Scopewriter commands
#define SCOPEWRITER_WRITE  	1
#define SCOPEWRITER_OSC  	2
#define SCOPEWRITER_DATA  	3
